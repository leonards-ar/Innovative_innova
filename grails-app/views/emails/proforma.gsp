            ...
            <h3><g:message code="proforma.notification" default="Proforma Notification"/></h3>
                ...
                <div id="detailListPanel" class="list">
                  <table style="margin-top: 5px;">
                    ...
                    <td colspan="4" style="color:red;text-align:right"><g:message code="proforma.discountAmount" default="Discount" /> <g:formatNumber number="${proformaInstance?.discount}" format="0.00"/> %</td>
