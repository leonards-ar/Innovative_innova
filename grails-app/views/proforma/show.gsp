...
<html>
    <head>
        ...
        <g:javascript>
          ...
          function print() {
            window.open("<g:createLink action='printProforma' id='${proformaInstance?.id}'/>","printWindow${proformaInstance?.id}","menubar=0,location=0,resizable=1,width=650,height=600,top=50,left=550");
          }
        </g:javascript>
    </head>
    <body>
